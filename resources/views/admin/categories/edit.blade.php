...
<div class="mb-8 flex items-center gap-4">
    ...
    <div>
        <h2 class="text-3xl font-black text-slate-800 tracking-tight">Edit Kategori</h2>
    </div>
</div>
...
<div class="glass-panel max-w-md p-8">
    <form action="{{ route('categories.update', $category) }}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" name="name" value="{{ old('name', $category->name) }}" required autofocus class="glass-input">
